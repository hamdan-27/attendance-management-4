...
if(isset($_POST['loginsubmit'])){
    ...
    $sql = "SELECT * FROM users WHERE user_email = '$user_email' AND user_password = '$user_password' AND user_role = 'student'";
    ...
    if($final > 0){
        ...
        if($final_check_user > 0){
            ...
            echo "<script>alert('Only students can login')</script>";
        } else {
